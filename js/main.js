    ...
    _displayTime: function () {
      ...
      if (this.config.response.itemInfo.itemData.widgets && this.config.response.itemInfo.itemData.widgets.timeSlider) {
        ...
        if (timeProperties.endTime > timeProperties.startTime) {
		  ...
		  //The following has been added by Amy Fish to set slider on this map to start at the current time and date
		  var today = new Date();
		  var dd = today.getDate();
		  var mm = today.getMonth()+1; //January is 0!
		  var yyyy = today.getFullYear();
		  var newstartdate = new String();
		  newstartdate = mm + '/' + dd + '/' + yyyy + ' 01:00:00 PST';
		  var newstarttime = new String();
		  newstarttime = ' ' + today.getHours() + ':00:00 PST';
		  newstartdate = mm + '/' + dd + '/' + yyyy + newstarttime;
		  
		  timeExtent.startTime = new Date(newstartdate);  
		  ...
		  var newendtime = new String();
		  newendtime = mm + '/' + dd + '/' + yyyy + ' 23:00:00 PST';
		  timeExtent.endTime = new Date(newendtime);  
        }
      }
